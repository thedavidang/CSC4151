...
class Tab3Fragment : Fragment() {
    ...
    *
    * Parameters: isEnabled represents a Boolean of whether or not to enable the editOverlay.
    *
    * Returns: Nothing. */
    ...
    * Returns: Nothing. */
    ...
    /* Purpose: Controller method that disables and greys-out button or
    * enables and reveals category button.
    *
    ...
    * Returns: Nothing. */
    private fun submitEdit() {
        ...
        val category = categoryGroup.checkedRadioButtonId + 1
